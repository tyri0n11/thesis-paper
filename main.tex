...
The rapid acceleration of urbanization has necessitated the development of sophisticated municipal monitoring systems capable of processing high-velocity data for real-time decision-making. Conventional urban management frameworks often rely on periodic batch processing, leading to significant temporal gaps and fragmented situational awareness. This thesis presents \textbf{UrbanPulse}, a streaming-first urban intelligence platform designed to ingest, process, and analyze heterogeneous city-scale data streams, such as traffic congestion and meteorological conditions, to provide near-real-time insights into neighborhood dynamics.

The proposed architecture leverages a distributed event-driven approach using \textbf{Apache Kafka} for robust message queuing. A centralized \textbf{Data Lakehouse}—implemented via \textbf{MinIO}, \textbf{Apache Iceberg}, and \textbf{Project Nessie}—is utilized to ensure transactional integrity, schema evolution, and time-travel capabilities for historical analysis. The platform incorporates a specialized processing pipeline that transforms raw telemetry into meaningful neighborhood activity indicators through micro-batching and streaming services. Furthermore, a baseline machine learning module utilizing \textbf{XGBoost} is integrated to learn typical urban rhythms and detect anomalies, such as non-recurrent traffic incidents or weather-driven behavioral shifts.

Experimental results demonstrate that the streaming-first design significantly reduces the latency between event occurrence and actionable intelligence compared to traditional batch-based architectures. By providing an integrated view of city dynamics and automated anomaly detection, UrbanPulse offers municipal authorities a scalable, evidence-based foundation for optimizing resource allocation and enhancing urban operational resilience.

\vspace{0.5cm}
\noindent \textbf{Keywords:} Urban Intelligence, Streaming Systems, Data Engineering, Apache Iceberg, Kafka, Anomaly Detection, Smart City.
