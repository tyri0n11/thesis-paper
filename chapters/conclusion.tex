...
maintained a p95 end-to-end ingestion lag below 20~seconds, well
within the 30-second polling interval. The Server-Sent Events delivery
...
The dual-signal detector combining an online heavy-ratio Z-score over
Welford-maintained route windows with a per-route IsolationForest model
achieved a mean model
agreement of 96.3\% and a mean Jaccard similarity of 12.1\% across all
...
natural-language explainability at city scale, processing 32,302 real-world
observations across 20 routes, with 96.3\% dual-signal model agreement on
the 30,329-observation pre-cutoff training set. The primary avenue for future
