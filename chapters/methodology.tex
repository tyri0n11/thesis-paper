  ...
  iterates over 30 predefined inter-zone routes defined in a canonical                                                                                    
  ...
  yielding a total of 30 directed inter-zone origin–destination pairs.                                                                                    
  ...
  \texttt{random\_state}), feature schema, training data time                                                                                             
  can therefore be replayed against the same model version and                                                                                            
  data snapshot.                                                                                                                                          
