  ...
  independent duration-based anomaly rate estimate of $1.97\%$
  obtained by applying the per-route baseline Z-score threshold to
  the same training corpus, providing cross-signal validation that
