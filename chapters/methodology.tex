  ...
  produces an anomaly score $s(\mathbf{x}) \in [-1, 1]$. An                                                                                               
  observation is labelled anomalous if $s(\mathbf{x}) < 0$ (the                                                                                           
  scikit-learn convention, internally inverted to a binary label                                                                                          
  1 = anomaly, 0 = normal). Algorithm~\ref{alg:iforest} describes                                                                                         
  the full training and scoring pipeline.                                                                                                                 
                                                                                                                                                          
  \begin{algorithm}[H]                                                                                                                                    
      \small                                                                                                                                              
      \caption{$\hat{y} \gets
      \texttt{IForestScore}(\mathbf{x},\; f_{\theta})$}                                                                                                   
      \label{alg:iforest}                                                                                                                                 
      \begin{algorithmic}[1]                                                                                                                              
          ...
          \Comment{Scoring phase (on-demand)}                                                                                                             
          ...
          \State $\hat{y}_{\text{raw}} \gets f_{\theta}.\texttt{predict}
          (\mathbf{X}_{\text{feat}})$                                                                                                                     
          \Comment{Returns $-1$ (anomaly) or $+1$ (normal)}
          \State $\hat{y} \gets (\hat{y}_{\text{raw}} = -1)$                                                                                              
          \State \Return $\hat{y} \in \{0, 1\}^{|\mathcal{R}|}$                                                                                           
      \end{algorithmic}                                                                                                                                   
  \end{algorithm}                                                                                                                                         
