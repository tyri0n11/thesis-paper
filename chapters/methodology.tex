  ...
  30 routes completes within the 5-minute polling interval.                                                                                               
  ...
  domain model (\texttt{TrafficRouteObservation}) before publication.
  ...
  \begin{enumerate}                                                                                                                                       
      ...
      \texttt{external\_context} ChromaDB collection for RAG retrieval                                                                                    
      (Section~\ref{sec:rag}).                                                                                                                            
  ...
  upload (\texttt{asynchronous=False}). If an upload fails, the consumer                                                                                  
  ...
  table into \texttt{gold.traffic\_hourly} — a pre-computed, per-route,
  ...
  under the column \texttt{duration\_zscore} — a historical naming
  ...
  where $h_{\text{avg}}$ is \texttt{avg\_heavy\_ratio},                                                                                                   
  ...
  dedicated \texttt{route\_iforest\_scores} PostgreSQL table via
